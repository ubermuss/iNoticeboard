...
({
  ...
  output+="<li class='list-group-item event-item-margin'><img src='img/placeholder.png' alt='' class='drawer-icon icon-margin'><span class='desc-info'>"+val.Location+"</span></li>"
  output+="<li class='list-group-item event-item-margin'><img src='img/coins.png' alt='' class='drawer-icon icon-margin'><span class='desc-info'>Tsh."+val.Price+"*</span></li>"
  output+="<li class='list-group-item event-item-margin'><img src='img/calendar.png' alt='' class='drawer-icon icon-margin'><span class='desc-info'>"+val.Date+"</span></li>"
  output+="<li class='list-group-item event-item-margin'><img src='img/smartphone.png' alt='' class='drawer-icon icon-margin'><span class='desc-info'>"+val.Contacts+"</span></li>"
